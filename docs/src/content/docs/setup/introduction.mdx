...
- Session resumption is not built in — the right implementation depends on your scale and persistence layer. The [session resumption](/advanced/session-resumption) page discusses this further.
