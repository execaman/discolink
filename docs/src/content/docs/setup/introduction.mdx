...
- Session resumption is not built in — the right implementation depends on your scale and persistence layer. The [session resumption](/discolink/advanced/session-resumption.html) page discusses this further.
